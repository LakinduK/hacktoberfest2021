  ...
  return (() => {
    ...
    var t = {
        d: (i, e) => {
          for (var o in e)
            t.o(e, o) &&
              !t.o(i, o) &&
              Object.defineProperty(i, o, { enumerable: !0, get: e[o] });
        },
    ...
    t.r(i),
      t.d(i, {
        ...
        EmitterClickMode: () => Fo,
        EmitterShapeType: () => Ho,
        ExternalInteractorBase: () => Ns,
        GradientType: () => x,
        HoverMode: () => p,
        InlineArrangement: () => qo,
    ...
    t.r(e),
      t.d(e, {
        ...
        getDistance: () => _,
        getDistances: () => q,
        getParticleBaseVelocity: () => B,
        getParticleDirectionAngle: () => V,
        getRangeMax: () => L,
        getRangeMin: () => I,
        getRangeValue: () => D,
        getValue: () => H,
    ...
    t.r(s),
      t.d(s, {
        ...
        colorToHsl: () => ft,
        colorToRgb: () => vt,
        getHslAnimationFromHsl: () => Ht,
        getHslFromAnimation: () => Ft,
        getLinkColor: () => It,
        getLinkRandomColor: () => Lt,
        getRandomRgbColor: () => Tt,
        getStyleFromHsl: () => Rt,
        getStyleFromHsv: () => At,
        getStyleFromRgb: () => Et,
        hslToHsv: () => xt,
    ...
    t.r(n),
      t.d(n, {
        ...
        drawLinkTriangle: () => Gt,
        drawParticle: () => jt,
        drawParticlePlugin: () => Yt,
        drawPlugin: () => Xt,
        drawShape: () => Qt,
        drawShapeAfterEffect: () => Jt,
        gradient: () => Nt,
        paintBase: () => Vt,
      });
    var a, r, l, c, d, h, u, p, v, f, y, m, b, g, w, x, k, P, M, z, C, O, S;
    !(function (t) {
      (t.bottom = "bottom"),
    ...
    class T {
      ...
      add(t) {
        return T.create(this.x + t.x, this.y + t.y);
      }
      addTo(t) {
      ...
      mult(t) {
        return T.create(this.x * t, this.y * t);
      }
      multTo(t) {
        (this.x *= t), (this.y *= t);
      }
    ...
    function H(t) {
      ...
      return D(e ? F(t.value, o) : t.value);
    }
    function q(t, i) {
      const e = t.x - i.x,
        o = t.y - i.y;
    ...
    function W(t, i, e, o) {
      return T.create((t.x * (e - o)) / (e + o) + (2 * i.x * o) / (e + o), t.y);
    }
    function G(t, i) {
      switch (i) {
        case C.easeOutQuad:
    ...
    function K(t, i, e = !0) {
      return t[void 0 !== i && e ? i % t.length : Z(t)];
    }
    function tt(t, i, e, o) {
      return it(et(t, null != e ? e : 0), i, o);
    }
    function it(t, i, e) {
      let o = !0;
      return (
        (e && e !== l.bottom) || (o = t.top < i.height),
        !o || (e && e !== l.left) || (o = t.right > 0),
        !o || (e && e !== l.right) || (o = t.left < i.width),
        !o || (e && e !== l.top) || (o = t.bottom > 0),
        o
      );
    }
    function et(t, i) {
      ...
      for (const e of i) {
        ...
        for (const i in e) {
          ...
          const o = e[i],
            ...
            n = t;
          n[i] =
            s && Array.isArray(o) ? o.map((t) => ot(n[i], t)) : ot(n[i], o);
        }
      }
      return t;
    }
    ...
    function nt(t, i, e) {
      if (i instanceof Array)
        for (const o of i) {
          const i = o.mode;
          o.enable && X(t, i) && at(o, e);
        }
      else {
        const o = i.mode;
        i.enable && X(t, o) && at(i, e);
      }
    }
    function at(t, i) {
      const e = t.selectors;
    ...
    function lt(t) {
      return {
        ...
        velocity: t.velocity,
        factor: T.create(
          H(t.options.bounce.horizontal),
          H(t.options.bounce.vertical)
        ),
      };
    }
    function ct(t, i) {
    ...
    function dt(t, i) {
      const e = et(t.getPosition(), t.getRadius()),
        o = N(
    ...
    function vt(t, i, e = !0) {
      ...
      if ("string" == typeof a.value)
        r = a.value === ht.randomColorValue ? Tt() : bt(a.value);
      else if (a.value instanceof Array) {
        r = vt({ value: K(a.value, i, e) });
      } else {
        const t = a.value,
        ...
        if (void 0 !== i.r) r = i;
          ...
          if (void 0 !== i.h && void 0 !== i.l) r = gt(i);
          else {
            const i = null !== (n = t.hsv) && void 0 !== n ? n : a.value;
            void 0 !== i.h && void 0 !== i.v && (r = zt(i));
          }
        }
      }
      return r;
    ...
    function mt(t) {
      var i;
      return null === (i = pt(t)) || void 0 === i ? void 0 : i.a;
    }
    function bt(t) {
      return pt(t);
    }
    ...
    function Tt(t) {
      const i = null != t ? t : 0;
      return {
        b: Math.floor(A(F(i, 256))),
        g: Math.floor(A(F(i, 256))),
        r: Math.floor(A(F(i, 256))),
      };
    }
    function Et(t, i) {
    ...
    function Dt(t, i, e, o) {
      ...
      return (
        void 0 === s.r && (s = gt(t)),
        void 0 === n.r && (n = gt(i)),
        { b: R(s.b, n.b, e, o), g: R(s.g, n.g, e, o), r: R(s.r, n.r, e, o) }
      );
    }
    function It(t, i, e) {
      var o, s;
      if (e === ht.randomColorValue) return Tt();
      if ("mid" !== e) return e;
      {
        const e =
          ...
          n =
            null !== (s = null == i ? void 0 : i.getFillColor()) && void 0 !== s
              ...
              ? void 0
              : i.getStrokeColor();
        if (e && n && i) return Dt(e, n, t.getRadius(), i.getRadius());
        {
          const t = null != e ? e : n;
          if (t) return gt(t);
        }
    ...
    function Ht(t, i, e) {
      ...
      return i && (qt(o.h, i.h, e), qt(o.s, i.s, e), qt(o.l, i.l, e)), o;
    }
    function qt(t, i, e) {
      if (((t.enable = i.enable), t.enable)) {
        if (((t.velocity = (i.speed / 100) * e), i.sync)) return;
        (t.status = b.increasing),
    ...
    function Wt(t, i, e, o, s, n, a, r, l, c, d, h) {
      let u = !1;
      if (_(e, o) <= s) _t(t, e, o), (u = !0);
      else if (a) {
        let i, a;
        const r = q(e, { x: o.x - n.width, y: o.y });
        if (r.distance <= s) {
          const t = e.y - (r.dy / r.dx) * e.x;
          (i = { x: 0, y: t }), (a = { x: n.width, y: t });
        } else {
          const t = q(e, { x: o.x, y: o.y - n.height });
          if (t.distance <= s) {
            const o = -(e.y - (t.dy / t.dx) * e.x) / (t.dy / t.dx);
            (i = { x: o, y: 0 }), (a = { x: o, y: n.height });
          } else {
            const t = q(e, { x: o.x - n.width, y: o.y - n.height });
            if (t.distance <= s) {
        ...
        i && a && (_t(t, e, i), _t(t, o, a), (u = !0));
      }
      if (u) {
        if (
          ((t.lineWidth = i),
          r && (t.globalCompositeOperation = l),
          (t.strokeStyle = Et(c, d)),
          h.enable)
        ) {
          const i = vt(h.color);
          i && ((t.shadowBlur = h.blur), (t.shadowColor = Et(i)));
        }
        t.stroke();
      }
    }
    function Gt(t, i, e, o, s, n, a, r) {
      !(function (t, i, e, o) {
        t.beginPath(),
          t.moveTo(i.x, i.y),
          t.lineTo(e.x, e.y),
    ...
    function Nt(t, i, e, o) {
      ...
      const r = i.getPosition(),
        l = e.getPosition(),
        c = Dt(n, a, i.getRadius(), e.getRadius()),
        d = t.createLinearGradient(r.x, r.y, l.x, l.y);
      return (
        d.addColorStop(0, Rt(n, o)),
        d.addColorStop(s > 1 ? 1 : s, Et(c, o)),
        d.addColorStop(1, Rt(a, o)),
        d
      );
    }
    function $t(t, i, e, o, s, n) {
      t.save(),
        _t(t, e, o),
        (t.strokeStyle = Et(s, n)),
        (t.lineWidth = i),
        t.stroke(),
        t.restore();
    }
    function jt(t, i, e, o, s, n, a, r, l, c, d, h) {
      var u, p;
      ...
      i.save(),
        f.enable || y.enable
          ? i.setTransform(
              y.enable ? Math.cos(e.rollAngle) : 1,
              f.enable ? Math.cos(e.tilt.value) * e.tilt.cosDirection : 0,
              f.enable ? Math.sin(e.tilt.value) * e.tilt.sinDirection : 0,
              y.enable ? Math.sin(e.rollAngle) : 1,
              v.x,
              v.y
            )
          : i.translate(v.x, v.y),
        i.beginPath();
      const m = e.rotate.value + (e.options.rotate.path ? e.velocity.angle : 0);
      0 !== m && i.rotate(m), a && (i.globalCompositeOperation = r);
      const b = e.shadowColor;
      if (
        (d.enable &&
          b &&
          ((i.shadowBlur = d.blur),
    ...
    function Zt(t, i, e, o, s, n, a, r, l) {
      const c = i.getPosition();
      if ((e && (t.strokeStyle = Rt(e, s)), 0 === n)) return;
      t.lineWidth = n;
      const d = (a * Math.PI) / 180;
      t.beginPath(), t.ellipse(c.x, c.y, o / 2, 2 * o, d, r, l), t.stroke();
    }
    (ht.canvasClass = "tsparticles-canvas-el"),
      (ht.randomColorValue = "random"),
      (ht.midColorValue = "mid"),
      (ht.touchEndEvent = "touchend"),
      (ht.mouseDownEvent = "mousedown"),
      (ht.mouseUpEvent = "mouseup"),
      (ht.mouseMoveEvent = "mousemove"),
      (ht.touchStartEvent = "touchstart"),
      (ht.touchMoveEvent = "touchmove"),
      (ht.mouseLeaveEvent = "mouseleave"),
      (ht.mouseOutEvent = "mouseout"),
      (ht.touchCancelEvent = "touchcancel"),
      (ht.resizeEvent = "resize"),
      (ht.visibilityChangeEvent = "visibilitychange"),
      (ht.noPolygonDataLoaded = "No polygon data loaded."),
      (ht.noPolygonFound =
    ...
    class ti extends Kt {
      ...
      contains(t) {
        return _(t, this.position) <= this.radius;
      }
      intersects(t) {
        const i = t,
          e = t,
    ...
    class ei extends ti {
      ...
      intersects(t) {
        ...
        if (void 0 !== e.radius) {
          const t = new ti(o.x, o.y, 2 * e.radius);
          return super.intersects(t);
        }
        if (void 0 !== i.size) {
          const t = new ii(o.x, o.y, 2 * i.size.width, 2 * i.size.height);
          return super.intersects(t);
        }
        return !1;
      }
    }
    function oi(t, i, e, o, s) {
      if (o) {
        let o = { passive: !0 };
    ...
    class si {
      ...
      manageListeners(t) {
        ...
        let n = ht.mouseLeaveEvent;
        if (s === S.window)
          (e.interactivity.element = window), (n = ht.mouseOutEvent);
        ...
        (o.interactivity.events.onHover.enable ||
          ...
          (oi(a, ht.mouseMoveEvent, this.mouseMoveHandler, t),
          oi(a, ht.touchStartEvent, this.touchStartHandler, t),
          oi(a, ht.touchMoveEvent, this.touchMoveHandler, t),
          o.interactivity.events.onClick.enable
            ? (oi(a, ht.touchEndEvent, this.touchEndClickHandler, t),
              oi(a, ht.mouseUpEvent, this.mouseUpHandler, t),
              oi(a, ht.mouseDownEvent, this.mouseDownHandler, t))
            : oi(a, ht.touchEndEvent, this.touchEndHandler, t),
          oi(a, n, this.mouseLeaveHandler, t),
          oi(a, ht.touchCancelEvent, this.touchCancelHandler, t)),
          e.canvas.element &&
          ...
          o.interactivity.events.resize &&
            ("undefined" != typeof ResizeObserver
              ...
              : oi(window, ht.resizeEvent, this.resizeHandler, t)),
          document &&
            oi(
              document,
              ht.visibilityChangeEvent,
      ...
      mouseTouchMove(t) {
        ...
        d && ((d.x *= u), (d.y *= u)),
          ...
          (l.interactivity.status = ht.mouseMoveEvent);
      }
      mouseTouchFinish() {
        const t = this.container.interactivity;
        if (void 0 === t) return;
      ...
      handleClickMode(t) {
        ...
        switch (t) {
          case d.push:
            if (o > 0) {
              const t = K([void 0, ...e.interactivity.modes.push.groups]),
    ...
    class pi {
      static getPlugin(t) {
        return ni.find((i) => i.id === t);
      }
      static addPlugin(t) {
        pi.getPlugin(t.id) || ni.push(t);
      }
      ...
      static loadOptions(t, i) {
        for (const e of ni) e.loadOptions(t, i);
      }
      static getPreset(t) {
        return di.get(t);
      }
      static addPreset(t, i, e = !1) {
        (!e && pi.getPreset(t)) || di.set(t, i);
      }
      static addShapeDrawer(t, i) {
        pi.getShapeDrawer(t) || hi.set(t, i);
      }
      ...
      static addPathGenerator(t, i) {
        pi.getPathGenerator(t) || ui.set(t, i);
      }
      static getInteractors(t) {
        let i = li.get(t);
        return i || ((i = [...ai.values()].map((i) => i(t))), li.set(t, i)), i;
      }
      ...
      static getUpdaters(t) {
        let i = ci.get(t);
        return i || ((i = [...ri.values()].map((i) => i(t))), ci.set(t, i)), i;
      }
    ...
    class fi {
      ...
      subdivide() {
        const t = this.rectangle.position.x,
          ...
          s = this.capacity;
        (this.northEast = new fi(new ii(t, i, e / 2, o / 2), s)),
          (this.northWest = new fi(new ii(t + e / 2, i, e / 2, o / 2), s)),
          (this.southEast = new fi(new ii(t, i + o / 2, e / 2, o / 2), s)),
          (this.southWest = new fi(
            new ii(t + e / 2, i + o / 2, e / 2, o / 2),
            s
          )),
          (this.divided = !0);
      }
      ...
      queryCircle(t, i) {
        return this.query(new ti(t.x, t.y, i));
      }
      queryCircleWarp(t, i, e) {
        const o = e,
          s = e;
        return this.query(
          new ei(t.x, t.y, i, void 0 !== o.canvas ? o.canvas.size : s)
        );
      }
      queryRectangle(t, i) {
        return this.query(new ii(t.x, t.y, i.width, i.height));
      }
      query(t, i) {
        var e, o, s, n;
        const a = null != i ? i : [];
        ...
        for (const i of this.points)
          (!t.contains(i.position) &&
            _(t.position, i.position) > i.particle.getRadius()) ||
            a.push(i.particle);
        return (
          this.divided &&
    ...
    class yi {
      ...
      paint() {
        ...
        this.draw((i) => {
          t.backgroundMask.enable && t.backgroundMask.cover && this.coverColor
            ? (Bt(i, this.size),
              this.paintBase(Et(this.coverColor, this.coverColor.a)))
            : this.paintBase();
        });
      }
      clear() {
        ...
        t.backgroundMask.enable
          ...
          ? this.paintBase(Et(this.trailFillColor, 1 / i.length))
          : this.draw((t) => {
              Bt(t, this.size);
            });
      }
      windowResize() {
        ...
        if (
          (this.resize(),
          1 !==
            (null === (t = this.resizeFactor) || void 0 === t
              ? void 0
              : t.width) || 1 !== this.resizeFactor.height)
        ) {
          i.updateActualOptions(), i.particles.setDensity();
          for (const [, t] of i.plugins) void 0 !== t.resize && t.resize();
        } else delete this.resizeFactor;
      }
      resize() {
        if (!this.element) return;
        const t = this.container,
      ...
      drawParticle(t, i) {
        ...
        if (!r || !l) {
          const t = ft(c.color);
          r || (r = d && void 0 !== t ? t : n || void 0),
            l || (l = d && void 0 !== t ? t : a || void 0);
        }
        const h = this.container.actualOptions,
          u = t.options.zIndex,
          p = Math.pow(1 - t.zIndexFactor, u.opacityRate),
          v = t.getRadius(),
          f = d
            ? c.opacity
        ...
        this.draw((e) => {
          const o = Math.pow(1 - t.zIndexFactor, u.sizeRate),
            s = l ? Rt(l, y * p) : b;
          v <= 0 ||
            (g.enable && this.drawOrbit(t, O.back),
            jt(
              this.container,
              e,
              t,
              ...
              b,
              s,
              h.backgroundMask.enable,
              h.backgroundMask.composite,
              v * o,
              m,
              t.options.shadow,
              t.gradient
            ),
            g.enable && this.drawOrbit(t, O.front));
        });
      }
      drawOrbit(t, i) {
        const e = this.container,
        ...
        let s, n;
        i === O.back
          ? ((s = Math.PI / 2), (n = (3 * Math.PI) / 2))
          : i === O.front
          ? ((s = (3 * Math.PI) / 2), (n = Math.PI / 2))
          : ((s = 0), (n = 2 * Math.PI)),
          this.draw((i) => {
            var a, r, l, c;
            Zt(
              i,
              t,
              null !== (a = t.orbitColor) && void 0 !== a
                ? a
                : t.getFillColor(),
              null !==
                (l =
                  null !== (r = t.orbitRadius) && void 0 !== r
                    ? r
                    : e.retina.orbitRadius) && void 0 !== l
                ? l
                : t.getRadius(),
              o.opacity,
              o.width,
              (null !== (c = t.orbitRotation) && void 0 !== c ? c : 0) *
                e.retina.pixelRatio,
              s,
              n
            );
      ...
      initBackground() {
        ...
        if (e) {
          if (t.color) {
            const i = vt(t.color);
            e.backgroundColor = i ? Et(i, t.opacity) : "";
      ...
      getPluginParticleColors(t) {
        ...
        for (const [, o] of this.container.plugins)
          if (
            (!i && o.particleFillColor && (i = ft(o.particleFillColor(t))),
            !e && o.particleStrokeColor && (e = ft(o.particleStrokeColor(t))),
            i && e)
          )
            break;
        return [i, e];
      ...
      initStyle() {
        ...
        i.fullScreen.enable
          ? ((this.originalStyle = ot({}, t.style)),
            (t.style.position = "fixed"),
            (t.style.zIndex = i.fullScreen.zIndex.toString(10)),
            (t.style.top = "0"),
            (t.style.left = "0"),
            (t.style.width = "100%"),
            (t.style.height = "100%"))
      ...
      lineStyle(t, i) {
        return this.draw((e) => {
          ...
          return Nt(e, t, i, o.links.opacity);
        });
      }
    }
    class mi {
    ...
    class bi {
      ...
      load(t) {
        void 0 !== t &&
          ...
          (this.color = mi.create(this.color, t.color)),
    ...
    class gi {
      ...
      load(t) {
        void 0 !== t &&
          (void 0 !== t.color && (this.color = mi.create(this.color, t.color)),
          void 0 !== t.enable && (this.enable = t.enable),
    ...
    class ki {
      constructor() {
        (this.enable = !1),
          (this.length = 10),
          (this.fillColor = new mi()),
          (this.fillColor.value = "#000000");
      }
      load(t) {
        void 0 !== t &&
          (void 0 !== t.enable && (this.enable = t.enable),
          (this.fillColor = mi.create(this.fillColor, t.fillColor)),
    ...
    class Mi {
      constructor() {
        (this.random = new Pi()), (this.value = 0);
      }
      load(t) {
        t &&
    ...
    class Ci {
      ...
      load(t) {
        void 0 !== t &&
          ...
          t.options && (this.options = ot(this.options, t.options)));
      }
    }
    class Oi {
      constructor() {
    ...
    class Ei {
      ...
      load(t) {
        t &&
          ...
          void 0 !== t.enable && (this.enable = t.enable),
          (this.position = t.position ? ot({}, t.position) : void 0));
      }
    }
    class Ri {
      constructor() {
    ...
    class Hi {
      constructor() {
        (this.options = {}), (this.type = P.circle);
      }
      get image() {
        var t;
        return null !== (t = this.options[P.image]) && void 0 !== t
          ? t
          : this.options[P.images];
      }
      set image(t) {
        (this.options[P.image] = t), (this.options[P.images] = t);
      }
      get custom() {
        return this.options;
      }
      ...
      get character() {
        var t;
        return null !== (t = this.options[P.character]) && void 0 !== t
          ? t
          : this.options[P.char];
      }
      set character(t) {
        (this.options[P.character] = t), (this.options[P.char] = t);
      }
      get polygon() {
        var t;
        return null !== (t = this.options[P.polygon]) && void 0 !== t
          ? t
          : this.options[P.star];
      }
      set polygon(t) {
        (this.options[P.polygon] = t), (this.options[P.star] = t);
      }
      load(t) {
        var i, e, o;
        if (void 0 === t) return;
        ...
        this.loadShape(t.character, P.character, P.char, !0),
          this.loadShape(t.polygon, P.polygon, P.star, !1),
          this.loadShape(
    ...
    class Ni extends mi {
      ...
      static create(t, i) {
        const e = null != t ? t : new Ni();
        return (
          void 0 !== i && e.load("string" == typeof i ? { value: i } : i), e
        );
      }
      load(t) {
    ...
    class $i {
      ...
      load(t) {
        void 0 !== t &&
          (void 0 !== t.color && (this.color = Ni.create(this.color, t.color)),
          void 0 !== t.width && (this.width = t.width),
          void 0 !== t.opacity && (this.opacity = t.opacity));
      }
    }
    ...
    class Qi {
      constructor() {
        (this.horizontal = new ji()), (this.vertical = new ji());
      }
      load(t) {
        t &&
    ...
    class Zi {
      constructor() {
        (this.lines = new Yi()), (this.particles = new Yi());
      }
      load(t) {
        void 0 !== t &&
    ...
    class ie {
      constructor() {
        (this.count = 0), (this.delay = new Ki()), (this.duration = new te());
      }
      load(t) {
        void 0 !== t &&
          (void 0 !== t.count && (this.count = t.count),
    ...
    class se {
      ...
      load(t) {
        t &&
          ...
          void 0 !== t.particles && (this.particles = ot({}, t.particles)),
          void 0 !== t.sizeOffset && (this.sizeOffset = t.sizeOffset));
      }
    }
    class ne {
      constructor() {
        (this.mode = h.none), (this.split = new se());
      }
      load(t) {
        t &&
    ...
    class de {
      constructor() {
        (this.darken = new ce()),
          (this.enable = !1),
          (this.enlighten = new ce()),
          (this.speed = 25);
      }
      load(t) {
        t &&
          (void 0 !== t.backColor &&
            (this.backColor = mi.create(this.backColor, t.backColor)),
    ...
    class fe {
      constructor() {
        (this.angle = new ye()), (this.colors = []), (this.type = x.random);
      }
      load(t) {
        t &&
          (this.angle.load(t.angle),
    ...
    class me {
      constructor() {
        (this.value = 0), (this.animation = new we());
      }
      load(t) {
        t &&
          (this.animation.load(t.animation),
    ...
    class be {
      constructor() {
        (this.stop = 0), (this.value = new Ni());
      }
      load(t) {
        t &&
          (void 0 !== t.stop && (this.stop = t.stop),
          (this.value = Ni.create(this.value, t.value)),
          void 0 !== t.opacity &&
            ((this.opacity = new me()),
    ...
    class xe {
      ...
      load(t) {
        ...
        if (void 0 === t) return;
        this.bounce.load(t.bounce),
          (this.color = Ni.create(this.color, t.color)),
        ...
        h &&
          (h instanceof Array
            ...
            : (this.stroke instanceof Array && (this.stroke = new $i()),
              this.stroke.load(h)));
        const u = t.gradient;
        u &&
          (u instanceof Array
            ...
            : (this.gradient instanceof Array && (this.gradient = new fe()),
    ...
    class ke extends T {
      ...
      add(t) {
        return t instanceof ke
          ? ke.create(this.x + t.x, this.y + t.y, this.z + t.z)
          : super.add(t);
      }
      addTo(t) {
        super.addTo(t), t instanceof ke && (this.z += t.z);
      }
      sub(t) {
        return t instanceof ke
          ? ke.create(this.x - t.x, this.y - t.y, this.z - t.z)
      ...
      subFrom(t) {
        super.subFrom(t), t instanceof ke && (this.z -= t.z);
      }
      mult(t) {
        return ke.create(this.x * t, this.y * t, this.z * t);
      }
      multTo(t) {
      ...
      copy() {
        return ke.clone(this);
      }
      setTo(t) {
        super.setTo(t), t instanceof ke && (this.z = t.z);
      }
    }
    class Pe {
      constructor(t, i, e, o, s) {
        var n, a, l, d, h, u, p, v, f, y;
        (this.id = t),
          (this.container = i),
          (this.group = s),
          (this.fill = !0),
        ...
        const m = i.retina.pixelRatio,
          ...
          x = new xe();
        x.load(w.particles);
        const k = x.shape.type,
          P = x.reduceDuplicates;
        if (
          ((this.shape = k instanceof Array ? K(k, this.id, P) : k),
          null == o ? void 0 : o.shape)
        ) {
          if (o.shape.type) {
            const t = o.shape.type;
            this.shape = t instanceof Array ? K(t, this.id, P) : t;
          }
          const t = new Hi();
          t.load(o.shape),
            this.shape && (this.shapeData = this.loadShapeData(t, P));
        } else this.shapeData = this.loadShapeData(x.shape, P);
        void 0 !== o && x.load(o),
          void 0 !==
          ...
          (this.close =
            null !==
              ...
              : this.close),
          (this.options = x);
        const z = D(this.options.zIndex.value);
        (this.pathDelay = 1e3 * H(this.options.move.path.delay)),
          (this.wobbleDistance = 0),
          i.retina.initParticle(this);
        const C = this.options.size,
          O = H(C) * i.retina.pixelRatio,
          S = C.value;
        this.size = {
          enable: C.animation.enable,
          value: O,
          max: L(S) * m,
          min: I(S) * m,
          loops: 0,
          maxLoops: C.animation.count,
        };
        const R = C.animation;
        if (R.enable) {
          switch (((this.size.status = b.increasing), R.startValue)) {
            case M.min:
              (this.size.value = this.size.min),
                (this.size.status = b.increasing);
              break;
            case M.random:
              (this.size.value = A(this.size) * m),
                (this.size.status =
                  Math.random() >= 0.5 ? b.increasing : b.decreasing);
              break;
            case M.max:
            default:
              (this.size.value = this.size.max),
                (this.size.status = b.decreasing);
          }
          (this.size.velocity =
            ((null !== (p = this.sizeAnimationSpeed) && void 0 !== p
              ? p
        ...
        (this.direction = V(this.options.move.direction)),
          (this.bubble = { inRange: !1 }),
          (this.initialVelocity = this.calculateVelocity()),
          (this.velocity = this.initialVelocity.copy());
        const F = this.options.rotate;
        this.rotate = {
          enable: F.animation.enable,
          value: (D(F.value) * Math.PI) / 180,
        };
        let q = F.direction;
        if (q === r.random) {
          q =
        ...
        const B = this.options.rotate.animation;
        B.enable &&
          ((this.rotate.velocity = (B.speed / 360) * i.retina.reduceFactor),
          B.sync || (this.rotate.velocity *= Math.random()));
        const W = this.options.tilt;
        this.tilt = {
          enable: W.enable,
          value: (D(W.value) * Math.PI) / 180,
        ...
        U.enable &&
          ((this.tilt.velocity = (U.speed / 360) * i.retina.reduceFactor),
          U.sync || (this.tilt.velocity *= Math.random()));
        const N = x.orbit;
        N.enable &&
          ((this.orbitRotation = D(N.rotation.value)),
          (this.orbitColor = ft(N.color)));
        const $ = ft(this.options.color, this.id, P);
        $ &&
          (this.color = Ht(
            $,
            this.options.color.animation,
            i.retina.reduceFactor
          ));
        const j =
          this.options.gradient instanceof Array
            ? K(this.options.gradient)
            : this.options.gradient;
        if (j) {
          this.gradient = {
            angle: {
              value: j.angle.value,
              enable: j.angle.animation.enable,
              velocity: (j.angle.animation.speed / 360) * i.retina.reduceFactor,
            },
            type: j.type,
            colors: [],
          };
          let t = j.angle.direction;
          if (t === r.random) {
            t =
              Math.floor(2 * Math.random()) > 0
                ? r.counterClockwise
          ...
          switch (t) {
            case r.counterClockwise:
            case "counterClockwise":
              this.gradient.angle.status = b.decreasing;
              break;
            case r.clockwise:
              this.gradient.angle.status = b.increasing;
          }
          for (const t of j.colors) {
            const e = ft(t.value, this.id, P);
            if (e) {
              const o = Ht(e, t.value.animation, i.retina.reduceFactor),
                s = {
                  stop: t.stop,
                  value: o,
                  opacity: t.opacity
                    ? {
                        enable: t.opacity.animation.enable,
                        max: L(t.opacity.value),
                        min: I(t.opacity.value),
                        status: b.increasing,
                        value: D(t.opacity.value),
                        velocity:
                          (t.opacity.animation.speed / 100) *
                          i.retina.reduceFactor,
                      }
                    : void 0,
                };
              if (t.opacity && s.opacity) {
                const i = t.opacity.value;
                (s.opacity.min = I(i)), (s.opacity.max = L(i));
                switch (t.opacity.animation.startValue) {
                  case M.min:
                    (s.opacity.value = s.opacity.min),
                      (s.opacity.status = b.increasing);
                    break;
                  case M.random:
                    (s.opacity.value = A(s.opacity)),
                      (s.opacity.status =
                        Math.random() >= 0.5 ? b.increasing : b.decreasing);
                    break;
                  case M.max:
                  default:
                    (s.opacity.value = s.opacity.max),
                      (s.opacity.status = b.decreasing);
                }
              }
              this.gradient.colors.push(s);
            }
          }
        }
        const Q = this.options.roll;
        Q.enable
          ? (this.color &&
              (Q.backColor
                ? (this.backColor = ft(Q.backColor))
                : Q.darken.enable && Q.enlighten.enable
                ? ((this.alterType =
                    Math.random() >= 0.5 ? g.darken : g.enlighten),
                  (this.alterValue =
                    this.alterType === g.darken
                      ? Q.darken.value
                      : Q.enlighten.value))
                : Q.darken.enable
                ? ((this.alterType = g.darken),
                  (this.alterValue = Q.darken.value))
                : Q.enlighten.enable &&
                  ((this.alterType = g.enlighten),
                  (this.alterValue = Q.enlighten.value))),
            (this.rollAngle = Math.random() * Math.PI * 2),
            (this.rollSpeed = D(Q.speed) / 360))
          : ((this.rollAngle = 0), (this.rollSpeed = 0));
        const J = this.options.wobble;
        J.enable
          ? ((this.wobbleAngle = Math.random() * Math.PI * 2),
            (this.wobbleSpeed = D(J.speed) / 360))
          : ((this.wobbleAngle = 0), (this.wobbleSpeed = 0)),
          (this.position = this.calcPosition(i, e, E(z, 0, i.zLayers))),
          (this.initialPosition = this.position.copy()),
          (this.offset = T.origin);
        const X = i.particles;
        (X.needsSort = X.needsSort || X.lastZIndex < this.position.z),
          (X.lastZIndex = this.position.z),
          (this.zIndexFactor = this.position.z / i.zLayers);
        const Y = this.options.opacity;
        this.opacity = {
          enable: Y.animation.enable,
          max: L(Y.value),
          min: I(Y.value),
          value: D(Y.value),
          loops: 0,
          maxLoops: Y.animation.count,
        };
        const Z = Y.animation;
        if (Z.enable) {
          ...
          const t = Y.value;
          switch (
            ((this.opacity.min = I(t)), (this.opacity.max = L(t)), Z.startValue)
          ) {
            case M.min:
              ...
              break;
            case M.random:
              (this.opacity.value = A(this.opacity)),
                (this.opacity.status =
                  Math.random() >= 0.5 ? b.increasing : b.decreasing);
              break;
            case M.max:
            default:
              (this.opacity.value = this.opacity.max),
                (this.opacity.status = b.decreasing);
          }
          (this.opacity.velocity = (Z.speed / 100) * i.retina.reduceFactor),
            Z.sync || (this.opacity.velocity *= Math.random());
        }
        this.sides = 24;
        let tt = i.drawers.get(this.shape);
        tt ||
          ((tt = pi.getShapeDrawer(this.shape)),
          tt && i.drawers.set(this.shape, tt)),
          (null == tt ? void 0 : tt.loadShape) &&
            (null == tt || tt.loadShape(this));
        const it = null == tt ? void 0 : tt.getSidesCount;
        it && (this.sides = it(this)),
          (this.stroke =
            this.options.stroke instanceof Array
              ? K(this.options.stroke, this.id, P)
              : this.options.stroke),
          (this.strokeWidth = this.stroke.width * i.retina.pixelRatio);
        const et =
          null !== (v = ft(this.stroke.color)) && void 0 !== v
            ? v
            : this.getFillColor();
        if (
          (et &&
            (this.strokeColor = Ht(
              et,
              null === (f = this.stroke.color) || void 0 === f
                ? void 0
                : f.animation,
              i.retina.reduceFactor
            )),
          ...
          const t =
              null !== (y = this.options.move.spin.position) && void 0 !== y
                ? y
                : { x: 50, y: 50 },
            e = {
            ...
            o = _(this.getPosition(), e);
          this.spin = {
            center: e,
            direction: this.velocity.x >= 0 ? r.clockwise : r.counterClockwise,
            angle: this.velocity.angle,
            radius: o,
            acceleration: D(this.options.move.spin.acceleration),
          };
        }
        (this.shadowColor = vt(this.options.shadow.color)),
          tt && tt.particleInit && tt.particleInit(i, this);
        for (const [, t] of i.plugins)
      ...
      getFillColor() {
        ...
        const t = Ft(this.color);
        if (
          t &&
          (this.backColor || (this.alterType && void 0 !== this.alterValue))
        ) {
          if (Math.floor(this.rollAngle / (Math.PI / 2)) % 2) {
            if (this.backColor) return this.backColor;
            if (this.alterType && void 0 !== this.alterValue)
              return {
                h: t.h,
                s: t.s,
                l:
                  t.l +
                  (this.alterType === g.darken ? -1 : 1) * this.alterValue,
              };
          }
        }
        return t;
      ...
      calcPosition(t, i, e, o = 0) {
        ...
        for (const [, o] of t.plugins) {
          const t =
            void 0 !== o.particlePosition
              ...
              : void 0;
          if (void 0 !== t) return ke.create(t.x, t.y, e);
        }
        const d = t.canvas.size,
          ...
          v = (i) => {
            (X(i, f.bounce) || X(i, f.bounceHorizontal)) &&
              (h.x > t.canvas.size.width - 2 * u
                ? (h.x -= u)
                : h.x < 2 * u && (h.x += u));
          },
          y = (i) => {
            (X(i, f.bounce) || X(i, f.bounceVertical)) &&
              (h.y > t.canvas.size.height - 2 * u
                ? (h.y -= u)
                : h.y < 2 * u && (h.y += u));
          };
        return (
          ...
          y(null !== (l = p.top) && void 0 !== l ? l : p.default),
          y(null !== (c = p.bottom) && void 0 !== c ? c : p.default),
      ...
      checkOverlap(t, i = 0) {
        ...
        for (const i of this.container.particles.array)
          if (_(t, i.position) < o + i.getRadius()) {
            a = !0;
            break;
          }
        return a;
      ...
      loadShapeData(t, i) {
        ...
        if (e) return ot({}, e instanceof Array ? K(e, this.id, i) : e);
      }
      loadLife() {
        const t = this.container,
          i = this.options,
          ...
          o = {
            delay: t.retina.reduceFactor
              ? ((D(e.delay.value) * (e.delay.sync ? 1 : Math.random())) /
                  t.retina.reduceFactor) *
                1e3
              : 0,
            delayTime: 0,
            duration: t.retina.reduceFactor
              ? ((D(e.duration.value) * (e.duration.sync ? 1 : Math.random())) /
                  t.retina.reduceFactor) *
                1e3
              : 0,
            time: 0,
    ...
    class ze {
      ...
      moveParticle(t, i) {
        ...
        const r = this.container,
          l = this.getProximitySpeedFactor(t),
          c =
            (null !== (e = t.moveSpeed) && void 0 !== e
              ? e
              : (t.moveSpeed = D(a.speed) * r.retina.pixelRatio)) *
            r.retina.reduceFactor,
          d =
            null !== (o = t.moveDrift) && void 0 !== o
              ? o
              : (t.moveDrift = D(t.options.move.drift) * r.retina.pixelRatio),
          h = L(n.size.value) * r.retina.pixelRatio,
          u =
            c * (((a.size ? t.getRadius() / h : 1) * l * (i.factor || 1)) / 2);
        this.applyPath(t, i);
        const p = a.gravity,
          v = p.enable && p.inverse ? -1 : 1;
        p.enable &&
          u &&
          (t.velocity.y += (v * (p.acceleration * i.factor)) / (60 * u)),
          d && u && (t.velocity.x += (d * i.factor) / (60 * u));
        const f = 1 - t.options.move.decay;
        1 != f && t.velocity.multTo(f);
        const y = t.velocity.mult(u),
          m = null !== (s = t.maxSpeed) && void 0 !== s ? s : r.retina.maxSpeed;
        p.enable &&
          p.maxSpeed > 0 &&
          ((!p.inverse && y.y >= 0 && y.y >= m) ||
            (p.inverse && y.y <= 0 && y.y <= -m)) &&
          ((y.y = v * m), u && (t.velocity.y = y.y / u));
        const b = t.options.zIndex,
          g = Math.pow(1 - t.zIndexFactor, b.velocityRate);
        a.spin.enable
          ? this.spin(t, u)
          : (1 != g && y.multTo(g),
            t.position.addTo(y),
      ...
      spin(t, i) {
        ...
        if (!t.spin) return;
        const o = {
          x: t.spin.direction === r.clockwise ? Math.cos : Math.sin,
          y: t.spin.direction === r.clockwise ? Math.sin : Math.cos,
        };
      ...
      applyPath(t, i) {
        ...
        t.velocity.addTo(s),
          e.clamp &&
            ((t.velocity.x = E(t.velocity.x, -1, 1)),
            (t.velocity.y = E(t.velocity.y, -1, 1))),
          (t.lastPathTime -= t.pathDelay);
      }
      moveParallax(t) {
        const i = this.container,
          e = i.actualOptions;
        if (j() || !e.interactivity.events.onHover.parallax.enable) return;
      ...
      getProximitySpeedFactor(t) {
        const i = this.container,
          e = i.actualOptions;
        if (!X(p.slow, e.interactivity.events.onHover.mode)) return 1;
        const o = this.container.interactivity.mouse.position;
        if (!o) return 1;
        const s = _(o, t.getPosition()),
    ...
    class Ce {
      constructor(t) {
        (this.container = t),
          ...
          (this.interactionManager = new Me(t));
        const i = this.container.canvas.size;
        (this.linksColors = new Map()),
          (this.quadTree = new fi(
            new ii(
              -i.width / 4,
              -i.height / 4,
              (3 * i.width) / 2,
          ...
          (this.updaters = pi.getUpdaters(t));
      }
      get count() {
      ...
      update(t) {
        ...
        for (const o of this.array) {
          ...
          this.mover.move(o, t),
            o.destroyed
              ? e.push(o)
              : this.quadTree.insert(new vi(o.getPosition(), o));
        }
      ...
      addSplitParticle(t) {
        const i = t.options.destroy.split,
          e = new xe();
        e.load(t.options);
        const o = D(i.factor.value);
        e.color.load({ value: { hsl: t.getFillColor() } }),
          "number" == typeof e.size.value
            ? (e.size.value /= o)
            : ((e.size.value.min /= o), (e.size.value.max /= o)),
          e.load(i.particles);
        const s = i.sizeOffset ? F(-t.size.value, t.size.value) : 0,
          n = { x: t.position.x + A(s), y: t.position.y + A(s) };
        return this.pushParticle(
          ...
          (i) =>
            !(i.size.value < 0.5) &&
            ((i.velocity.length = A(F(t.velocity.length, i.velocity.length))),
      ...
      getLinkFrequency(t, i) {
        ...
        return (
          void 0 === o && ((o = Math.random()), this.linksFreq.set(e, o)), o
        );
      }
      getTriangleFrequency(t, i, e) {
        ...
        return (
          void 0 === r && ((r = Math.random()), this.trianglesFreq.set(a, r)), r
        );
      }
      addManualParticles() {
        const t = this.container,
      ...
      pushParticle(t, i, e, o) {
        try {
          const s = new Pe(this.nextId, this.container, t, i, e);
          let n = !0;
          if ((o && (n = o(s)), !n)) return;
    ...
    class Oe {
      ...
      init() {
        const t = this.container,
          i = t.actualOptions;
        this.pixelRatio = !i.detectRetina || j() ? 1 : window.devicePixelRatio;
        const e = this.container.actualOptions.motion;
        if (e && (e.disable || e.reduce.value))
          if (j() || "undefined" == typeof matchMedia || !matchMedia)
            this.reduceFactor = 1;
          else {
      ...
      initParticle(t) {
        const i = t.options,
          ...
          o = i.move.distance,
          s = i.orbit;
        (t.attractDistance = i.move.attract.distance * e),
          (t.linksDistance = i.links.distance * e),
          (t.linksWidth = i.links.width * e),
          (t.moveDrift = D(i.move.drift) * e),
          (t.moveSpeed = D(i.move.speed) * e),
          (t.sizeAnimationSpeed = i.size.animation.speed * e),
          (t.orbitRadius =
            void 0 !== (null == s ? void 0 : s.radius) ? s.radius * e : void 0),
          t.spin && (t.spin.acceleration = D(i.move.spin.acceleration) * e);
        ...
        (n.horizontal = void 0 !== o.horizontal ? o.horizontal * e : void 0),
          ...
          (t.wobbleDistance = D(i.wobble.distance) * e),
          (t.maxSpeed = i.move.gravity.maxSpeed * e);
      }
      ...
      load(t) {
        ...
        void 0 !== s &&
          (s instanceof Array
            ...
            : ((this.onDiv = new Ee()), this.onDiv.load(s))),
          this.onHover.load(
        ...
        void 0 !== t &&
          ...
          void 0 !== t.color &&
            (t.color instanceof Array
              ? (this.color = t.color.map((t) => mi.create(void 0, t)))
              : (this.color instanceof Array && (this.color = new mi()),
                (this.color = mi.create(this.color, t.color)))),
          void 0 !== t.size && (this.size = t.size));
      }
    }
    ...
    class qe {
      constructor() {
        (this.distance = 80), (this.links = new He()), (this.radius = 60);
      }
      get line_linked() {
        return this.links;
      }
    ...
    class Ve {
      constructor() {
        (this.distance = 100), (this.links = new _e());
      }
      get line_linked() {
        return this.links;
      }
    ...
    class Je {
      ...
      load(t) {
        void 0 !== t &&
          ((this.start = mi.create(this.start, t.start)),
          (this.stop = mi.create(this.stop, t.stop)));
      }
    }
    class Xe {
      constructor() {
        (this.gradient = new Je()), (this.radius = 1e3);
      }
      load(t) {
        void 0 !== t &&
    ...
    class Ze {
      constructor() {
        (this.area = new Xe()), (this.shadow = new Ye());
      }
      load(t) {
        ...
        void 0 !== s && (this.detectsOn = s),
          ...
          !0 ===
            ...
            (this.events.onHover.mode instanceof Array
              ? this.events.onHover.mode.indexOf(p.slow) < 0 &&
                this.events.onHover.mode.push(p.slow)
              : this.events.onHover.mode !== p.slow &&
    ...
    class eo {
      constructor() {
        (this.color = new mi()), (this.opacity = 1);
      }
      load(t) {
        void 0 !== t &&
          (void 0 !== t.color && (this.color = mi.create(this.color, t.color)),
    ...
    class ao {
      constructor() {
        (this.name = ""), (this.default = new no());
      }
      load(t) {
        void 0 !== t &&
          (void 0 !== t.name && (this.name = t.name),
          this.default.load(t.default),
          void 0 !== t.options && (this.options = ot({}, t.options)));
      }
    }
    class ro {
      constructor() {
    ...
    class co {
      constructor() {
        (this.disable = !1), (this.reduce = new lo());
      }
      load(t) {
        t &&
    ...
    class po {
      constructor() {
        (this.autoPlay = !0),
          (this.background = new so()),
          (this.backgroundMask = new oo()),
          (this.fullScreen = new ro()),
          (this.detectRetina = !0),
          (this.duration = 0),
          (this.fpsLimit = 60),
          (this.interactivity = new io()),
          (this.manualParticles = []),
          (this.motion = new co()),
          (this.particles = new xe()),
          (this.pauseOnBlur = !0),
      ...
      setTheme(t) {
        if (t) {
          ...
          let i = this.themes.find(
            (i) =>
              i.default.value &&
              ((i.default.mode === m.dark && t) ||
                (i.default.mode === m.light && !t))
          );
          i ||
            (i = this.themes.find(
              (t) => t.default.value && t.default.mode === m.any
            )),
            i && this.load(i.options);
        }
      }
      importPreset(t) {
        this.load(pi.getPreset(t));
      }
      setResponsive(t, i, e) {
        var o;
        this.load(e),
          this.load(
            null === (o = this.responsive.find((e) => e.maxWidth * i > t)) ||
              void 0 === o
              ? void 0
              : o.options
          );
    ...
    class fo {
      constructor(t, i, ...e) {
        (this.id = t),
          ...
          (this.retina = new Oe(this)),
          (this.canvas = new yi(this)),
          (this.particles = new Ce(this)),
          (this.drawer = new Se(this)),
          (this.pathGenerator = {
            generate: () => {
              const t = T.create(0, 0);
              return (
          ...
          (this.density = 1),
          (this._options = new po()),
          (this.actualOptions = new po());
        for (const t of e) this._options.load(pi.getPreset(t));
        const o = pi.getSupportedShapes();
        for (const t of o) {
          const i = pi.getShapeDrawer(t);
          i && this.drawers.set(t, i);
        }
        this._options.load(this._sourceOptions),
          (this.eventListeners = new si(this)),
      ...
      pause() {
        if (
          (void 0 !== this.drawAnimationFrame &&
            (J()(this.drawAnimationFrame), delete this.drawAnimationFrame),
          !this.paused)
        ) {
      ...
      reset() {
        return (this._options = new po()), this.refresh();
      }
      stop() {
        if (this.started) {
          (this.firstStart = !0),
      ...
      init() {
        return vo(this, void 0, void 0, function* () {
          (this.actualOptions = new po()),
            ...
            (this.duration = D(this.actualOptions.duration)),
            (this.lifeTime = 0),
            (this.fpsLimit =
              this.actualOptions.fpsLimit > 0
                ? this.actualOptions.fpsLimit
                : 60);
          const t = pi.getAvailablePlugins(this);
          ...
          if (i.generator) {
            const t = pi.getPathGenerator(i.generator);
            t &&
              (t.init && (this.pathGenerator.init = t.init),
              t.generate && (this.pathGenerator.generate = t.generate),
              t.update && (this.pathGenerator.update = t.update));
    ...
    class go {
      ...
      static set(t, i, e, o) {
        return yo(this, void 0, void 0, function* () {
          const s = e instanceof Array ? K(e, o) : e,
            n = go.dom(),
            a = n.findIndex((i) => i.id === t);
          if (a >= 0) {
            const t = go.domItem(a);
          ...
          if ("canvas" === i.tagName.toLowerCase()) (r = i), (l = !1);
            ...
            t.length
              ? ((r = t[0]),
                r.className || (r.className = ht.canvasClass),
                (l = !1))
              : ((l = !0),
                (r = document.createElement("canvas")),
                (r.className = ht.canvasClass),
                (r.style.width = "100%"),
                (r.style.height = "100%"),
                i.appendChild(r));
          }
      ...
      static loadJSON(t, i, e) {
        return yo(this, void 0, void 0, function* () {
          const o = i instanceof Array ? K(i, e) : i,
            s = yield fetch(o);
          if (s.ok) return go.load(t, yield s.json());
          bo(s.status);
        });
      }
    ...
    class zo {
      constructor() {
        wo.set(this, void 0), Po(this, wo, !1, "f");
      }
      init() {
        Mo(this, wo, "f") || Po(this, wo, !0, "f");
      }
      loadFromArray(t, i, e) {
        return ko(this, void 0, void 0, function* () {
          return go.load(t, i, e);
        });
      }
      load(t, i) {
        return ko(this, void 0, void 0, function* () {
      ...
      loadJSON(t, i, e) {
        return go.loadJSON(t, i, e);
      }
      setJSON(t, i, e, o) {
        return ko(this, void 0, void 0, function* () {
          return go.setJSON(t, i, e, o);
        });
      }
      setOnClickHandler(t) {
        go.setOnClickHandler(t);
      }
      dom() {
        return go.dom();
      }
      ...
      addPathGenerator(t, i) {
        pi.addPathGenerator(t, i);
      }
      addInteractor(t, i) {
        pi.addInteractor(t, i);
      }
      addParticleUpdater(t, i) {
        pi.addParticleUpdater(t, i);
      }
    }
    wo = new WeakMap();
    class Co {
      constructor(t, i, e, o) {
        ...
        (this.absorbers = t),
          (this.container = i),
          (this.initialPosition = o ? T.create(o.x, o.y) : void 0),
          (this.options = e),
          (this.dragging = !1),
          (this.name = this.options.name),
          (this.opacity = this.options.opacity),
          (this.size = D(e.size.value) * i.retina.pixelRatio),
          (this.mass = this.size * e.size.density * i.retina.reduceFactor);
        const r = e.size.limit;
        this.limit =
          void 0 !== r ? r * i.retina.pixelRatio * i.retina.reduceFactor : r;
        const l = "string" == typeof e.color ? { value: e.color } : e.color;
        (this.color =
          null !== (s = vt(l)) && void 0 !== s ? s : { b: 0, g: 0, r: 0 }),
          (this.position =
            null !==
              (a =
      ...
      attract(t) {
        ...
        if (e.draggable) {
          ...
          if (t.clicking && t.downPosition) {
            _(this.position, t.downPosition) <= this.size &&
              (this.dragging = !0);
        ...
        const o = t.getPosition(),
          { dx: s, dy: n, distance: a } = q(this.position, o),
          r = T.create(s, n);
        if (
      ...
      resize() {
        ...
        this.position =
          t && tt(t, this.container.canvas.size) ? t : this.calcPosition();
      }
      draw(t) {
        t.translate(this.position.x, this.position.y),
          ...
          t.closePath(),
          (t.fillStyle = Et(this.color, this.opacity)),
          t.fill();
      }
      calcPosition() {
        var t, i;
      ...
      updateParticlePosition(t, i) {
        ...
        if (t.needsNewPosition) {
          const i = t.getRadius();
          (t.position.x =
            (s.width - 2 * i) * (0.2 * Math.random() - 0.1 + 1) + i),
            (t.position.y =
              (s.height - 2 * i) * (0.2 * Math.random() - 0.1 + 1) + i),
            (t.needsNewPosition = !1);
        }
        if (this.options.orbits) {
          if (
            (void 0 === t.absorberOrbit &&
              ((t.absorberOrbit = T.create(0, 0)),
              (t.absorberOrbit.length = _(t.getPosition(), this.position)),
          ...
          void 0 === t.absorberOrbitDirection &&
            (t.absorberOrbitDirection =
              t.velocity.x >= 0 ? r.clockwise : r.counterClockwise);
          const n = t.absorberOrbit.length,
            a = t.absorberOrbit.angle,
            l = t.absorberOrbitDirection;
          (t.velocity.x = 0), (t.velocity.y = 0);
          const c = {
            x: l === r.clockwise ? Math.cos : Math.sin,
            y: l === r.clockwise ? Math.sin : Math.cos,
          };
          (t.position.x = this.position.x + n * c.x(a)),
            (t.position.y = this.position.y + n * c.y(a)),
            (t.absorberOrbit.length -= i.length),
            (t.absorberOrbit.angle +=
              (((null !== (e = t.moveSpeed) && void 0 !== e ? e : 0) *
                o.retina.pixelRatio) /
                100) *
    ...
    class To {
      ...
      init(t) {
        ...
        t.absorbers &&
          (t.absorbers instanceof Array
            ...
            : (this.absorbers instanceof Array && (this.absorbers = new So()),
          ...
          (o &&
            (o instanceof Array
              ...
              : (this.interactivityAbsorbers instanceof Array &&
                  (this.interactivityAbsorbers = new So()),
      ...
      handleClickMode(t) {
        ...
        if (t === xo.absorber) {
          let t;
          o instanceof Array ? o.length > 0 && (t = K(o)) : (t = o);
          const s = null != t ? t : e instanceof Array ? K(e) : e,
            n = i.interactivity.mouse.clickPosition;
          this.addAbsorber(s, n);
        }
      }
      addAbsorber(t, i) {
        const e = new Co(this, this.container, t, i);
          ...
          s instanceof Array
            ...
            : (void 0 !== s ||
                ((null ===
                  ...
                  ? void 0
                  : o.mode) &&
                  X(xo.absorber, t.interactivity.events.onClick.mode))) &&
              (n = !0),
          n
        );
      }
      loadOptions(t, i) {
        ...
        if (n)
          if (n instanceof Array)
            ...
            void 0 === (null == t ? void 0 : t.load) &&
              (s.interactivity.modes.absorbers = t = new So()),
              t.load(n);
          }
      }
    }
    ...
    class Go {
        ...
        (this.emitters = t),
          ...
          (this.position =
            null !== (n = this.initialPosition) && void 0 !== n
              ...
              : this.calcPosition()),
          (this.name = e.name),
          (this.shape = Do.getShape(e.shape)),
          (this.fill = e.fill),
          Bo(this, Io, !this.emitterOptions.life.wait, "f"),
          Bo(this, Lo, !1, "f");
        let h = ot({}, this.emitterOptions.particles);
        null != h || (h = {}),
          ...
          (this.size =
            null !== (l = this.emitterOptions.size) && void 0 !== l
              ...
              : (() => {
                  const t = new Ro();
                  return t.load({ height: 0, mode: y.percent, width: 0 }), t;
                })()),
          (this.lifeCount =
      ...
      play() {
        ...
        if (
          ...
          if (void 0 === this.emitDelay) {
            const t = D(this.emitterOptions.rate.delay);
      ...
      emit() {
        if (this.paused) return;
        const t = D(this.emitterOptions.rate.quantity);
      ...
      emitParticles(t) {
        ...
        for (let r = 0; r < t; r++) {
          const t = ot({}, this.particlesOptions);
      ...
      setColorAnimation(t, i, e) {
        ...
        const n = A(t.offset),
          a = (1e3 * D(this.emitterOptions.rate.delay)) / s.retina.reduceFactor;
        return (
          (i +
    ...
    class $o {
      ...
      load(t) {
        void 0 !== t &&
          (void 0 !== t.autoPlay && (this.autoPlay = t.autoPlay),
          void 0 !== t.size &&
            (void 0 === this.size && (this.size = new Ro()),
            this.size.load(t.size)),
          void 0 !== t.direction && (this.direction = t.direction),
          ...
          void 0 !== t.position &&
            (this.position = { x: t.position.x, y: t.position.y }),
          void 0 !== t.spawnColor &&
            (void 0 === this.spawnColor && (this.spawnColor = new Ni()),
    ...
    class jo {
      ...
      init(t) {
        ...
        t.emitters &&
          (t.emitters instanceof Array
            ...
            : (this.emitters instanceof Array && (this.emitters = new $o()),
          ...
          (o &&
            (o instanceof Array
              ...
              : (this.interactivityEmitters instanceof Array &&
                  (this.interactivityEmitters = new $o()),
      ...
      addEmitter(t, i) {
        const e = new Go(this, this.container, t, i);
        return this.array.push(e), e;
      }
      removeEmitter(t) {
        const i = this.array.indexOf(t);
      ...
      randomPosition(t, i, e) {
        const [o, s] = [i.x / 2, i.y / 2],
          ...
          a =
            ...
            ((l = o) * (c = s)) /
              Math.sqrt(
                Math.pow(c * Math.cos(d), 2) + Math.pow(l * Math.sin(d), 2)
              )),
    ...
    class Xo {
      randomPosition(t, i, e) {
        if (e) return { x: Jo(t.x, i.x), y: Jo(t.y, i.y) };
        {
          const e = i.x / 2,
            o = i.y / 2,
      ...
      needsPlugin(t) {
        ...
        return (
          ...
          (!!(null ===
            ...
            ? void 0
            : o.mode) &&
            X(Fo.emitter, t.interactivity.events.onClick.mode))
        );
      }
      loadOptions(t, i) {
        var e, o;
        ...
        if (n)
          if (n instanceof Array)
            ...
            void 0 === (null == t ? void 0 : t.load) &&
              (s.interactivity.modes.emitters = t = new $o()),
              t.load(n);
          }
      }
    }
    ...
    class Zo {
      constructor() {
        (this.color = new mi()), (this.width = 0.5), (this.opacity = 1);
      }
      load(t) {
        var i;
        void 0 !== t &&
          ...
          "string" == typeof this.color.value &&
            (this.opacity =
              null !== (i = mt(this.color.value)) && void 0 !== i
                ? i
                : this.opacity),
          void 0 !== t.opacity && (this.opacity = t.opacity),
          void 0 !== t.width && (this.width = t.width));
    ...
    class Ko {
      constructor() {
        (this.enable = !1), (this.stroke = new Zo());
      }
      get lineWidth() {
      ...
      set lineColor(t) {
        this.stroke.color = mi.create(this.stroke.color, t);
      }
      load(t) {
        var i;
        if (void 0 !== t) {
    ...
    class ts {
      constructor() {
        (this.radius = 10), (this.type = _o.path);
      }
      load(t) {
        void 0 !== t &&
          (void 0 !== t.radius && (this.radius = t.radius),
    ...
    class is {
      constructor() {
        this.arrangement = qo.onePerPoint;
      }
      load(t) {
        void 0 !== t &&
        ...
        if (void 0 !== t) {
          ...
          void 0 !== e && this.inline.load(e),
            ...
            void 0 !== t.enable
              ...
              : (this.enable = this.type !== Vo.none),
            void 0 !== t.url && (this.url = t.url),
            void 0 !== t.data &&
              ("string" == typeof t.data
                ? (this.data = t.data)
                : ((this.data = new es()), this.data.load(t.data))),
            void 0 !== t.position && (this.position = ot({}, t.position));
        }
      }
    }
    var ss = function (t, i, e, o) {
      return new (e || (e = Promise))(function (s, n) {
        function a(t) {
          try {
            l(o.next(t));
    ...
    function as(t, i, e, o) {
      ...
      const s = vt(e.color);
      s &&
        ((t.strokeStyle = Et(s, e.opacity)),
        (t.lineWidth = e.width),
        t.stroke(i));
    }
    function rs(t, i, e) {
      const { dx: o, dy: s } = q(e, t),
        { dx: n, dy: a } = q(i, t),
        r = (o * n + s * a) / (Math.pow(n, 2) + Math.pow(a, 2));
      let l = t.x + n * r,
        c = t.y + a * r;
      return (
        r < 0 ? ((l = t.x), (c = t.y)) : r > 1 && ((l = i.x), (c = i.y)),
        { x: l, y: c, isOnSegment: r >= 0 && r <= 1 }
      );
    }
    function ls(t, i, e) {
      const { dx: o, dy: s } = q(t, i),
        n = Math.atan2(s, o),
        a = Math.sin(n),
        r = -Math.cos(n),
        l = 2 * (e.x * a + e.y * r);
    ...
    class cs {
      ...
      particlesInitialization() {
        ...
        return (
          !(
            !t.enable ||
            t.type !== Vo.inline ||
            (t.inline.arrangement !== qo.onePerPoint &&
              t.inline.arrangement !== qo.perPoint)
          ) && (this.drawPoints(), !0)
        );
      }
      particlePosition(t) {
      ...
      polygonBounce(t, i, e) {
        ...
        if (o.type === Vo.inside || o.type === Vo.outside) {
          let i, e, o;
        ...
        } else if (o.type === Vo.inline && t.initialPosition) {
          if (
            _(t.initialPosition, t.getPosition()) > this.polygonMaskMoveRadius
          )
            return (
      ...
      checkInsidePolygon(t) {
        ...
        const o = this.container,
          s = this.options;
        if (!s.enable || s.type === Vo.none || s.type === Vo.inline) return !0;
        if (!this.raw) throw new Error(ht.noPolygonFound);
        ...
        return s.type === Vo.inside ? l : s.type === Vo.outside && !l;
      }
      parseSvgPath(t, i) {
        var e, o, s;
        const n = null != i && i;
      ...
      getRandomPoint() {
        if (!this.raw || !this.raw.length)
          throw new Error(ht.noPolygonDataLoaded);
        const t = K(this.raw);
        return { x: t.x, y: t.y };
      }
        ...
        return null !==
          ...
          : void 0 !==
              (null === (o = null == t ? void 0 : t.polygon) || void 0 === o
                ? void 0
                : o.type) && t.polygon.type !== Vo.none;
      }
      loadOptions(t, i) {
        if (!this.needsPlugin(i)) return;
        const e = t;
        let o = e.polygon;
        void 0 === (null == o ? void 0 : o.load) && (e.polygon = o = new os()),
    ...
    class gs {
      constructor() {
        fs.set(this, void 0), ms(this, fs, [], "f");
      }
      getSidesCount() {
        return 12;
      }
      getImages(t) {
        const i = bs(this, fs, "f").find((i) => i.id === t.id);
        return (
          i ||
          (bs(this, fs, "f").push({ id: t.id, images: [] }), this.getImages(t))
        );
      }
      addImage(t, i) {
      ...
      init(t) {
        return ys(this, void 0, void 0, function* () {
          yield this.loadImagesFromParticlesOptions(
            t,
            t.actualOptions.particles
          ),
            yield this.loadImagesFromParticlesOptions(
              t,
              t.actualOptions.interactivity.modes.trail.particles
            );
          for (const i of t.actualOptions.manualParticles)
            yield this.loadImagesFromParticlesOptions(t, i.options);
          const i = t.actualOptions;
          if (i.emitters)
            if (i.emitters instanceof Array)
              for (const e of i.emitters)
                yield this.loadImagesFromParticlesOptions(t, e.particles);
            else
              yield this.loadImagesFromParticlesOptions(
                t,
                i.emitters.particles
              );
          const e = i.interactivity.modes.emitters;
          if (e)
            if (e instanceof Array)
              for (const i of e)
                yield this.loadImagesFromParticlesOptions(t, i.particles);
      ...
      loadImagesFromParticlesOptions(t, i) {
        ...
        return ys(this, void 0, void 0, function* () {
          ...
          if (
            ...
            !n.options ||
            (!X(P.image, n.type) && !X(P.images, n.type))
          )
            return;
          const a = bs(this, fs, "f").findIndex((i) => i.id === t.id);
          a >= 0 && bs(this, fs, "f").splice(a, 1);
          const r =
            null !== (e = n.options[P.images]) && void 0 !== e
              ? e
              : n.options[P.image];
          ...
          (null ===
            (s =
              null === (o = null == i ? void 0 : i.destroy) || void 0 === o
                ? void 0
                : o.split) || void 0 === s
            ? void 0
            : s.particles) &&
            (yield this.loadImagesFromParticlesOptions(
              t,
              null == i ? void 0 : i.destroy.split.particles
            ));
        });
      }
      loadImageShape(t, i) {
      ...
      loadShape(t) {
        ...
        const a = this.getImages(t.container).images,
          r = t.shapeData,
          l =
            null !== (i = a.find((t) => t.source === r.src)) && void 0 !== i
              ? i
              : a[0],
          c = t.getFillColor();
        let d;
        if (!l) return;
        if (void 0 !== l.svgData && r.replaceColor && c) {
          const i = (function (t, i, e) {
              ...
              if (o.includes("fill")) {
                ...
                return o.replace(t, () => Rt(i, e));
              }
              const s = o.indexOf(">");
              return `${o.substring(0, s)} fill="${Rt(i, e)}"${o.substring(s)}`;
            })(l, c, t.opacity.value),
            ...
            a = new Image();
          (d = {
            data: Object.assign(Object.assign({}, l), { svgData: i }),
            ratio: r.width / r.height,
            replaceColor:
              null !== (e = r.replaceColor) && void 0 !== e
                ? e
                : r.replace_color,
            source: r.src,
          }),
            a.addEventListener("load", () => {
              const i = t.image;
              i && ((i.loaded = !0), (l.element = a)), s.revokeObjectURL(n);
            }),
            a.addEventListener("error", () => {
              s.revokeObjectURL(n),
                ps(r.src).then((i) => {
                  const e = t.image;
                  e &&
                    ((l.element = null == i ? void 0 : i.element),
                    (e.loaded = !0));
                });
            }),
            (a.src = n);
          ...
          d = {
            ...
            ratio: r.width / r.height,
            replaceColor:
              null !== (o = r.replaceColor) && void 0 !== o
                ? o
                : r.replace_color,
            source: r.src,
          };
        ...
        const h = {
          image: d,
          fill: null !== (s = r.fill) && void 0 !== s ? s : t.fill,
          close: null !== (n = r.close) && void 0 !== n ? n : t.close,
        };
    ...
    function Ms(t) {
      !(function (t) {
        t.addShape("polygon", new ks());
      })(t),
        (function (t) {
          t.addShape("triangle", new Ps());
        })(t);
    }
    const zs = Math.sqrt(2);
    class Cs {
      getSidesCount() {
        return 4;
      }
      draw(t, i, e) {
        t.rect(-e / zs, -e / zs, (2 * e) / zs, (2 * e) / zs);
      }
    }
    class Os {
      getSidesCount(t) {
    ...
    class Es {
      ...
      init(t) {
        return Ss(this, void 0, void 0, function* () {
          const i = t.actualOptions;
          if (Ts.find((t) => X(t, i.particles.shape.type))) {
            const t = Ts.map((t) => i.particles.shape.options[t]).find(
              (t) => !!t
            );
            if (t instanceof Array) {
              const i = [];
              for (const e of t) i.push(Y(e));
              yield Promise.allSettled(i);
            } else void 0 !== t && (yield Y(t));
          }
        });
      }
      draw(t, i, e, o) {
        ...
        const c = i;
        void 0 === c.text &&
          (c.text = l instanceof Array ? K(l, i.randomIndexData) : l);
        const d = c.text,
        ...
        this.isEnabled(t) &&
          (function (t, i) {
            ...
            const o = t.options.rotate.animation,
              s =
                (null !== (e = t.rotate.velocity) && void 0 !== e ? e : 0) *
                i.factor,
              n = 2 * Math.PI;
            if (o.enable)
              switch (t.rotate.status) {
                case b.increasing:
                  (t.rotate.value += s),
                    t.rotate.value > n && (t.rotate.value -= n);
                  break;
                case b.decreasing:
                default:
                  (t.rotate.value -= s),
                    t.rotate.value < 0 && (t.rotate.value += n);
              }
          })(t, i);
      }
    }
    function As(t, i, e, o, s) {
      var n;
      const a = i;
      ...
      const r = A(e.offset),
        l =
          ...
          3.6 * r;
      s && a.status !== b.increasing
        ? ((a.value -= l),
          a.value < 0 && ((a.status = b.increasing), (a.value += a.value)))
        : ((a.value += l),
          s &&
            a.value > o &&
            ((a.status = b.decreasing), (a.value -= a.value % o))),
        a.value > o && (a.value %= o);
    }
    class Ds {
      isEnabled(t) {
      ...
      update(t, i) {
        !(function (t, i) {
          ...
          void 0 !== (null === (e = t.color) || void 0 === e ? void 0 : e.h) &&
            As(i, t.color.h, n.h, 360, !1),
            void 0 !==
              (null === (o = t.color) || void 0 === o ? void 0 : o.s) &&
              As(i, t.color.s, n.s, 100, !0),
            void 0 !==
              (null === (s = t.color) || void 0 === s ? void 0 : s.l) &&
              As(i, t.color.l, n.l, 100, !0);
        })(t, i);
      }
    }
    class Is {
      ...
      update(t, i) {
        ...
        (e.delay = 1e3 * D(r.delay.value)),
          (e.duration = 1e3 * D(r.duration.value));
      }
    }
    function Ls(t, i) {
      var e, o, s, n, a;
      ...
      if (
        ...
        switch (t.opacity.status) {
          case b.increasing:
            t.opacity.value >= l
              ? ((t.opacity.status = b.decreasing),
                t.opacity.loops || (t.opacity.loops = 0),
                t.opacity.loops++)
              : (t.opacity.value +=
                  (null !== (n = t.opacity.velocity) && void 0 !== n ? n : 0) *
                  i.factor);
            break;
          case b.decreasing:
            t.opacity.value <= r
              ? ((t.opacity.status = b.increasing),
                t.opacity.loops || (t.opacity.loops = 0),
                t.opacity.loops++)
              : (t.opacity.value -=
                  (null !== (a = t.opacity.velocity) && void 0 !== a ? a : 0) *
                  i.factor);
        }
        !(function (t, i, e, o) {
          ...
          t.destroyed || (t.opacity.value = E(t.opacity.value, r, l));
      }
    }
    class Fs {
      isEnabled(t) {
      ...
      update(t, i) {
        this.isEnabled(t) && Ls(t, i);
      }
    }
    function Hs(t, i) {
      var e, o, s, n;
      const a =
          (null !== (e = t.size.velocity) && void 0 !== e ? e : 0) * i.factor,
        r = t.size.min,
        l = t.size.max;
      if (
        !t.destroyed &&
        ...
        !(function (t, i, e, o) {
          ...
          t.destroyed || (t.size.value = E(t.size.value, r, l));
      }
    }
    class qs {
      isEnabled(t) {
      ...
      update(t, i) {
        this.isEnabled(t) && Hs(t, i);
      }
    }
    function _s(t, i, e, o, s) {
      var n;
      const a = i;
        ...
        this.isEnabled(t) &&
          (function (t, i) {
            ...
            const v =
              null !==
                (c =
                  null === (l = t.strokeColor) || void 0 === l
                    ? void 0
                    : l.l) && void 0 !== c
                ? c
                : null === (d = t.color) || void 0 === d
                ? void 0
                : d.l;
            v && _s(i, v, h.l, 100, !0);
          })(t, i);
    ...
    class Bs {
      ...
      destroy(t, i) {
        const e = this.container;
        tt(t.position, e.canvas.size, t.getRadius(), i) ||
          e.particles.remove(t, void 0, !0);
      }
      out(t, i) {
        const e = this.container;
        if (tt(t.position, e.canvas.size, t.getRadius(), i)) return;
        const o = t.options.move.warp,
          ...
          a = t.getRadius(),
          r = et(t.position, a);
        i === l.right && r.left > s.width + t.offset.x
          ? ((t.position.x = n.left),
          ...
          : i === l.left &&
            ...
            o ||
              ((t.position.y = Math.random() * s.height),
              (t.initialPosition.y = t.position.y))),
          i === l.bottom && r.top > s.height + t.offset.y
            ? (o ||
        ...
        !(function (t) {
          ...
          if (
            (t.direction === l.right &&
              ...
              i > 0) ||
            (t.direction === l.left && t.bounds.left <= 0 && i < 0)
          ) {
            const i = D(t.particle.options.bounce.horizontal.value);
          ...
          t.bounds.right >= t.canvasSize.width
            ...
            t.outMode === f.split && t.particle.destroy();
        })({
          particle: t,
          outMode: o,
          direction: e,
          ...
          (function (t) {
            if (
              ...
              let e = !1;
              if (
                (t.direction === l.bottom &&
                  t.bounds.bottom >= t.canvasSize.height &&
                  i > 0) ||
                (t.direction === l.top && t.bounds.top <= 0 && i < 0)
              ) {
                const i = D(t.particle.options.bounce.vertical.value);
      ...
      none(t, i) {
        if (
          (t.options.move.distance.horizontal &&
            (i === l.left || i === l.right)) ||
          (t.options.move.distance.vertical && (i === l.top || i === l.bottom))
        )
          return;
        ...
        if (e.enable) {
          const a = t.position;
          ((!e.inverse && a.y > s.height + n && i === l.bottom) ||
            (e.inverse && a.y < -n && i === l.top)) &&
          ...
          if (
            ...
            return;
          tt(t.position, o.canvas.size, n, i) || o.particles.remove(t);
        }
      }
    }
    class Ws {
        ...
        this.isEnabled(t) &&
          (function (t, i) {
            const e = t.options.roll,
              ...
              s = 2 * Math.PI;
            e.enable &&
              ((t.rollAngle += o), t.rollAngle > s && (t.rollAngle -= s));
          })(t, i);
      }
    }
    class Gs {
      ...
      update(t, i) {
        this.isEnabled(t) &&
          (function (t, i) {
            ...
            e.enable &&
              ((t.wobbleAngle += o),
              t.wobbleAngle > n && (t.wobbleAngle -= n),
              (t.position.x += s * Math.cos(t.wobbleAngle)),
              (t.position.y += s * Math.abs(Math.sin(t.wobbleAngle))));
          })(t, i);
      }
    }
    class Ns {
      constructor(t) {
        (this.container = t), (this.type = k.External);
      }
    }
    class $s extends Ns {
      constructor(t) {
      ...
      isEnabled() {
        ...
        const s = o.onHover.mode,
          n = o.onClick.mode;
        return X(p.attract, s) || X(d.attract, n);
      }
      reset() {}
      interact() {
        const t = this.container,
          i = t.actualOptions,
          e = t.interactivity.status === ht.mouseMoveEvent,
          o = i.interactivity.events,
          s = o.onHover.enable,
          n = o.onHover.mode,
          a = o.onClick.enable,
        ...
        e && s && X(p.attract, n)
          ? this.hoverAttract()
          : a && X(d.attract, r) && this.clickAttract();
      }
      hoverAttract() {
        const t = this.container,
        ...
        this.processAttract(i, e, new ti(i.x, i.y, e));
      }
      processAttract(t, i, e) {
        ...
        for (const e of n) {
          const { dx: o, dy: n, distance: a } = q(e.position, t),
            r = s.speed * s.factor,
            l = E(G(1 - a / i, s.easing) * r, 0, s.maxSpeed),
            c = T.create(0 === a ? r : (o / a) * l, 0 === a ? r : (n / a) * l);
    ...
    class js extends Ns {
      ...
      isEnabled() {
        const t = this.container,
          ...
          s = o.onDiv;
        return (
          (e.position && o.onHover.enable && X(p.bounce, o.onHover.mode)) ||
          st(u.bounce, s)
        );
      }
      interact() {
        ...
        e && o && X(p.bounce, s)
          ...
          : nt(u.bounce, n, (t, i) => this.singleSelectorBounce(t, i));
      }
      reset() {}
      processMouseBounce() {
        const t = this.container,
        ...
        e && this.processBounce(e, o, new ti(e.x, e.y, o + i));
      }
      ...
      processBounce(t, i, e) {
        ...
        for (const s of o)
          e instanceof ti
            ...
            : e instanceof ii && dt(s, et(t, i));
      }
    }
    var Qs;
    function Js(t, i, e, o) {
      if (i >= e) {
        return E(t + (i - e) * o, t, i);
      }
      if (i < e) {
        return E(t - (e - i) * o, i, t);
      }
    }
    !(function (t) {
    ...
    class Xs extends Ns {
      ...
      isEnabled() {
        ...
        const a = o.onHover.mode,
          r = o.onClick.mode;
        return X(p.bubble, a) || X(d.bubble, r) || n;
      }
      reset(t, i) {
        (t.bubble.inRange && !i) ||
          (delete t.bubble.div,
      ...
      interact() {
        ...
        o && X(p.bubble, s)
          ...
          : n && X(d.bubble, a)
          ? this.clickBubble()
          : nt(u.bubble, r, (t, i) => this.singleSelectorHover(t, i));
      }
        ...
        o.length &&
          o.forEach((t) => {
            ...
            for (const t of l) {
              ...
              t.bubble.inRange = !0;
              const i = rt(e.actualOptions.interactivity.modes.bubble.divs, o);
      ...
      process(t, i, e, o) {
        ...
        if (n !== l)
          if (s.bubble.durationEnd)
            c &&
              (h === Qs.size && delete t.bubble.radius,
              h === Qs.opacity && delete t.bubble.opacity);
          else if (i <= r) {
            if ((null != c ? c : d) !== n) {
              const i = d - (e * (d - n)) / a;
              h === Qs.size && (t.bubble.radius = i),
                h === Qs.opacity && (t.bubble.opacity = i);
            }
          } else
            h === Qs.size && delete t.bubble.radius,
              h === Qs.opacity && delete t.bubble.opacity;
      ...
      clickBubble() {
        ...
        for (const o of s) {
          ...
          const s = _(o.getPosition(), e),
            n =
              (new Date().getTime() - (t.interactivity.mouse.clickTime || 0)) /
              1e3;
          n > i.interactivity.modes.bubble.duration &&
            (t.bubble.durationEnd = !0),
            n > 2 * i.interactivity.modes.bubble.duration &&
          ...
          const a = {
            ...
            particlesObj: {
              optValue: L(o.options.size.value) * t.retina.pixelRatio,
              value: o.size.value,
            },
            type: Qs.size,
          };
          ...
          const r = {
            ...
            particlesObj: {
              optValue: L(o.options.opacity.value),
              value: o.opacity.value,
            },
            type: Qs.opacity,
          };
          this.process(o, s, n, r),
            t.bubble.durationEnd
              ? delete o.bubble.color
              : s <= t.retina.bubbleModeDistance
              ? this.hoverBubbleColor(o, s)
              : delete o.bubble.color;
        }
      }
      hoverBubble() {
        ...
        for (const s of o) {
          s.bubble.inRange = !0;
          const o = _(s.getPosition(), i),
            n = 1 - o / e;
          o <= e
            ? n >= 0 &&
              t.interactivity.status === ht.mouseMoveEvent &&
              (this.hoverBubbleSize(s, n),
              this.hoverBubbleOpacity(s, n),
              this.hoverBubbleColor(s, n))
            : this.reset(s),
            t.interactivity.status === ht.mouseLeaveEvent && this.reset(s);
        }
      }
      hoverBubbleSize(t, i, e) {
        ...
        if (void 0 === s) return;
        const n = L(t.options.size.value) * o.retina.pixelRatio,
          a = Js(t.size.value, s, n, i);
      ...
      hoverBubbleColor(t, i, e) {
        ...
        if (!t.bubble.finalColor) {
          const i = s.color;
          if (!i) return;
          const e = i instanceof Array ? K(i) : i;
          t.bubble.finalColor = ft(e);
        }
        if (t.bubble.finalColor)
          if (s.mix) {
            ...
            t.bubble.color = e
              ? yt(Dt(e, t.bubble.finalColor, 1 - i, i))
              : t.bubble.finalColor;
    ...
    class Ys extends Ns {
      ...
      isEnabled() {
        ...
        return (
          !(!e.onHover.enable || !i.position) && X(p.connect, e.onHover.mode)
        );
      }
      reset() {}
      interact() {
    ...
    class Zs extends Ns {
      ...
      isEnabled() {
        const t = this.container,
          i = t.interactivity.mouse,
          e = t.actualOptions.interactivity.events;
        return e.onHover.enable && !!i.position && X(p.grab, e.onHover.mode);
      }
      reset() {}
      interact() {
        var t;
        ...
        if (
          ...
          i.interactivity.status === ht.mouseMoveEvent
        ) {
          ...
          for (const r of a) {
            ...
            if (a <= n) {
              ...
              if (!i.particles.grabLineColor) {
                ...
                i.particles.grabLineColor = Lt(h, t.blink, t.consent);
              }
              const u = It(r, void 0, i.particles.grabLineColor);
              if (!u) return;
    ...
    class Ks extends Ns {
      ...
      isEnabled() {
        ...
        const a = o.onHover.mode,
          r = o.onClick.mode;
        return X(p.repulse, a) || X(d.repulse, r) || n;
      }
      reset() {}
      interact() {
        const t = this.container,
        ...
        e && s && X(p.repulse, n)
          ...
          : a && X(d.repulse, r)
          ? this.clickRepulse()
          : nt(u.repulse, l, (t, i) => this.singleSelectorRepulse(t, i));
      }
        ...
        o.length &&
          o.forEach((t) => {
            const o = t,
              ...
              l = rt(e.actualOptions.interactivity.modes.repulse.divs, o);
      ...
      hoverRepulse() {
        ...
        this.processRepulse(i, e, new ti(i.x, i.y, e));
      }
      processRepulse(t, i, e, o) {
        ...
        for (const e of a) {
          const { dx: n, dy: a, distance: l } = q(e.position, t),
            c =
              (null !== (s = null == o ? void 0 : o.speed) && void 0 !== s
                ? s
                : r.speed) * r.factor,
            d = E(G(1 - l / i, r.easing) * c, 0, r.maxSpeed),
            h = T.create(0 === l ? c : (n / l) * d, 0 === l ? c : (a / l) * d);
          e.position.addTo(h);
        }
      }
      clickRepulse() {
      ...
      isEnabled() {
        ...
        return (
          (e.clicking &&
            e.inside &&
            !!e.position &&
            X(d.trail, o.onClick.mode)) ||
          (e.inside && !!e.position && X(p.trail, o.onHover.mode))
        );
      }
      reset() {}
    }
    class en {
      constructor(t) {
        (this.container = t), (this.type = k.Particles);
      }
    }
    class on extends en {
      constructor(t) {
      ...
      interact(t) {
        ...
        const e = this.container,
          o =
            null !== (i = t.attractDistance) && void 0 !== i
              ? i
    ...
    class nn extends en {
      ...
      interact(t) {
        ...
        for (const i of s) {
          ...
          _(e, s) <= o + i.getRadius() && this.resolveCollision(t, i);
        }
      }
      resolveCollision(t, i) {
        switch (t.options.collisions.mode) {
          ...
          case v.destroy:
            !(function (t, i) {
              t.unbreakable || i.unbreakable || sn(t, i),
      ...
      absorb(t, i) {
        ...
        if (void 0 === t.getRadius() && void 0 !== i.getRadius()) t.destroy();
          ...
          if (t.getRadius() >= i.getRadius()) {
            const s = E(t.getRadius() / i.getRadius(), 0, i.getRadius()) * o;
            (t.size.value += s),
              (i.size.value -= s),
              i.getRadius() <= e.retina.pixelRatio &&
                ((i.size.value = 0), i.destroy());
          } else {
            const s = E(i.getRadius() / t.getRadius(), 0, t.getRadius()) * o;
            (t.size.value -= s),
              (i.size.value += s),
    ...
    function an(t, i, e, o, s) {
      let n = _(t, i);
      if (!s || n <= e) return n;
      if (((n = _(t, { x: i.x - o.width, y: i.y })), n <= e)) return n;
      if (((n = _(t, { x: i.x - o.width, y: i.y - o.height })), n <= e))
        return n;
      return (n = _(t, { x: i.x, y: i.y - o.height })), n;
    }
    class rn extends en {
      constructor(t) {
        super(t);
      ...
      interact(t) {
        ...
        const n = t.options.links,
          ...
          l = n.warp,
          c = l ? new ei(e.x, e.y, r, s) : new ti(e.x, e.y, r),
      ...
      setColor(t) {
        ...
        if (!o) {
          (o = Lt(e.color, e.blink, e.consent)),
            void 0 === e.id
    ...
    class ln {
      ...
      drawLinkTriangle(t, i, e) {
        ...
        s.canvas.draw((i) => {
          if (
            _(d, h) > s.retina.linksDistance ||
            _(u, h) > s.retina.linksDistance ||
            _(u, d) > s.retina.linksDistance
          )
            return;
          let e = vt(l.color);
          if (!e) {
      ...
      drawLinkLine(t, i) {
        ...
        e.canvas.draw((i) => {
          ...
          if (!d) return;
          const u =
              null !== (l = t.linksWidth) && void 0 !== l
                ? l
                : e.retina.linksWidth,
            p =
              null !== (c = t.linksDistance) && void 0 !== c
                ? c
    ...
    function dn(t) {
      !(function (t) {
        t.addInteractor("particlesLinks", (t) => new rn(t));
      })(t),
        (function (t) {
          const i = new cn();
          t.addPlugin(i);
    ...
    function hn(t) {
      !(function (t) {
        t.addInteractor("externalAttract", (t) => new $s(t));
      })(t),
        (function (t) {
          t.addInteractor("externalBounce", (t) => new js(t));
        })(t),
        (function (t) {
          t.addInteractor("externalBubble", (t) => new Xs(t));
        })(t),
        (function (t) {
          t.addInteractor("externalConnect", (t) => new Ys(t));
        })(t),
        (function (t) {
          t.addInteractor("externalGrab", (t) => new Zs(t));
        })(t),
        (function (t) {
          t.addInteractor("externalRepulse", (t) => new Ks(t));
        })(t),
        (function (t) {
          t.addInteractor("externalTrail", (t) => new tn(t));
        })(t),
        (function (t) {
          t.addInteractor("particlesAttract", (t) => new on(t));
        })(t),
        (function (t) {
          t.addInteractor("particlesCollisions", (t) => new nn(t));
        })(t),
        dn(t),
        (function (t) {
          t.addShape("circle", new hs());
        })(t),
        (function (t) {
          const i = new gs();
        ...
        (function (t) {
          t.addShape("star", new Os());
        })(t),
        (function (t) {
          const i = new Es();
          for (const e of Ts) t.addShape(e, i);
        })(t),
        (function (t) {
          t.addParticleUpdater("life", (t) => new Is(t));
        })(t),
        (function (t) {
          t.addParticleUpdater("opacity", () => new Fs());
        })(t),
        (function (t) {
          t.addParticleUpdater("size", () => new qs());
        })(t),
        (function (t) {
          t.addParticleUpdater("angle", () => new Rs());
        })(t),
        (function (t) {
          t.addParticleUpdater("tilt", () => new Gs());
        })(t),
        (function (t) {
          t.addParticleUpdater("roll", () => new Ws());
        })(t),
        (function (t) {
          t.addParticleUpdater("wobble", () => new Us());
        })(t),
        (function (t) {
          t.addParticleUpdater("color", () => new Ds());
        })(t),
        (function (t) {
          t.addParticleUpdater("strokeColor", () => new Vs());
        })(t),
        (function (t) {
          t.addParticleUpdater("outModes", (t) => new Bs(t));
        })(t);
    }
    function un(t) {
      hn(t),
        ...
        (function (t) {
          ...
          t.addPlugin(i),
            ...
            t.addEmitterShape(Ho.circle, new Qo()),
            t.addEmitterShape(Ho.square, new Xo());
        })(t),
        (function (t) {
          const i = new ds();
          t.addPlugin(i);
